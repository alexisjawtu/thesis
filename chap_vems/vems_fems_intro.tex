...
One fact to note
about the projection $\hat\pi$ in~(\ref{projection}) is that, by
...
\noindent{\color{blue}\#\#\#\#\#\#\# and
for every $u_\pi$ ... escribir bien
esta demostracion, que es totalmente estandar.} 
\end{theorem}
