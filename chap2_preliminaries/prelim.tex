...
\begin{IEEEeqnarray*}{rCcCl}
	P_k (\be) & = & P_k(\xi) & = & \{\,\mbox{polynomials of maximum degree k in arc length on e}\,\}\\[5pt]
	P_k (f) & = & P_k(\xi_1,\xi_2) & = & \{\,\mbox{polynomials of maximum degree k in $\xi_1$,$\xi_2$ on f}\,\}
\end{IEEEeqnarray*}
...
\end{IEEEeqnarray}
\end{defi}
{\color{Orange} mandar al cap de FEs
