...
For the first definition we refer the reader to~\cite{brennerscott,ciarlet}. 
\begin{defi}
...
\begin{IEEEeqnarray*}{rCl}
  ...
  \tilde{P}_k(E) & = & \{\,\mbox{homogeneous polynomials of degree $k$ over E}\,\}.\\[5pt]
\end{IEEEeqnarray*}
...
\end{IEEEeqnarray}
\end{defi}
\begin{remark}\label{tensor_prod_dim}
