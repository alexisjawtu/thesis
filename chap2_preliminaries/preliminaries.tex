...
\begin{IEEEeqnarray}{ll}
	...
	\IEEEeqnarraymulticol{2}{l}{\nonumber\textrm{ for each horizontal face $f$ with normal } \boldsymbol{\nu} = (0,0,\pm1) \textrm{;}}\\[8pt]
 	...
 	Q_{k-1,k-2},\\
 	\IEEEeqnarraymulticol{2}{l}{\nonumber\textrm{ for the face } f \subseteq \{ y=0 \} \textrm{ with normal }\boldsymbol{n} = (0,-1,0) \textrm{;}}\\[8pt]
	...
	Q_{k-1,k-2}\textrm{, }\\
	\IEEEeqnarraymulticol{2}{l}{\nonumber\textrm{ for the face }f \subseteq \{x+y=1\} \textrm{ with normal }\boldsymbol{n} = (1,1,0) \textrm{;}}\\[8pt]
