...
\noindent{\color{BrickRed}\#\#\#\#\#\#\# defi de hcurl y hdiv}
...
\end{defi}
With an elementary application of integration by parts for distributional
derivatives we get the following Lemma.
...
\noindent{\color{BrickRed}\#\#\#\#\#\#\# poner como conjunto con desigualdades} 
...
\begin{IEEEeqnarray*}{rCl}
    ...
    \label{derivadaPiola}\yesnumber D\tilde{\boldsymbol{\sigma}}(\tilde{\textbf{x}}) & = &
