...
\def\conform{
 \begin{figure}[!ht]
    ...
    \subfloat
    {
      \includegraphics[width=.4\textwidth]{./figures/conform9.png}
    }\\
    \subfloat
    {
      \includegraphics[width=.4\textwidth]{./figures/conform4.png}
    }
    \subfloat
    {
      \includegraphics[width=.4\textwidth]{./figures/conform5.png}
    }
