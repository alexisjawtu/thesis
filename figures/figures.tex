  ...
  \begin{IEEEeqnarraybox*}
    ...
    \IEEEeqnarraystrutsizeadd{2pt}{6pt}]{v/c/v/c/v/c/v/c/v/c/v/}
      ...
      \IEEEeqnarrayseprow[5pt]\\
         & p_0 && {\textstyle 1-\left(\frac{n-l}n\right)^\gamma      } 
               && {\textstyle \left(\frac{n-l}n\right)^\gamma-\left(\frac{i+j}n\right)^\gamma   }
               && {\textstyle \frac in \left(\frac{i+j}n\right)^{\gamma-1}   }
               && {\textstyle \frac jn \left(\frac{i+j}n\right)^{\gamma-1} }
         & \\
      \IEEEeqnarrayrulerow\\
      \IEEEeqnarrayseprow[5pt]\\
         & p_1 && {\textstyle 1-\left(\frac{n-l}n\right)^\gamma} 
               && {\textstyle \left(\frac{n-l}n\right)^\gamma-\left(\frac{i+j+1}n\right)^\gamma }
               && {\textstyle \frac{i+1}n \left(\frac{i+1+j}n\right)^{\gamma-1} }
               && {\textstyle \frac jn \left(\frac{i+1+j}n\right)^{\gamma-1} }
         & \\
      \IEEEeqnarrayrulerow\\
      \IEEEeqnarrayseprow[5pt]\\
         & p_2 && {\textstyle 1-\left(\frac{n-l}n\right)^\gamma }
               && {\textstyle \left(\frac{n-l}n\right)^\gamma-\left(\frac{i+j+1}n\right)^\gamma }
               && {\textstyle \frac in \left(\frac{i+j+1}n\right)^{\gamma-1} }
               && {\textstyle \frac{j+1}n \left(\frac{i+1+j}n\right)^{\gamma-1}}
         & \\
      \IEEEeqnarrayrulerow\\
      \IEEEeqnarrayseprow[5pt]\\
         & p_3 && {\textstyle 1-\left(\frac{n-l-1}n\right)^\gamma }
               && {\textstyle \left(\frac{n-l-1}n\right)^\gamma-\left(\frac{i+j}n\right)^\gamma }
               && {\textstyle \frac in \left(\frac{i+j}n\right)^{\gamma-1} }
               && {\textstyle \frac jn \left(\frac{i+j}n\right)^{\gamma-1}}
         & \\
      \IEEEeqnarrayrulerow\\
      \IEEEeqnarrayseprow[5pt]\\
         & p_4 && {\textstyle 1-\left(\frac{n-l-1}n\right)^\gamma }
               && {\textstyle \left(\frac{n-l-1}n\right)^\gamma-\left(\frac{i+1+j}n\right)^\gamma }
               && {\textstyle \frac{i+1}n \left(\frac{i+1+j}n\right)^{\gamma-1} }
               && {\textstyle \frac jn \left(\frac{i+1+j}n\right)^{\gamma-1}}
         & \\
      \IEEEeqnarrayrulerow\\
      \IEEEeqnarrayseprow[5pt]\\
         & p_5 && {\textstyle 1-\left(\frac{n-l-1}n\right)^\gamma }
               && {\textstyle \left(\frac{n-l-1}n\right)^\gamma-\left(\frac{i+j+1}n\right)^\gamma }
               && {\textstyle \frac in \left(\frac{i+j+1}n\right)^{\gamma-1} }
               && {\textstyle \frac{j+1}n \left(\frac{i+1+j}n\right)^{\gamma-1}}
         & \\
      \IEEEeqnarrayrulerow
    ...
    \IEEEeqnarraystrutsizeadd{2pt}{6pt}]{v/c/v/c/v/c/v/c/v/c/v/}
      ...
      \IEEEeqnarrayseprow[5pt]\\
         & p_1  && {\textstyle 1-\left(\frac{n-l}n\right)^\gamma }  
               && {\textstyle \left(\frac{n-l}n\right)^\gamma-\left(\frac{i+j+1}n\right)^\gamma }
               && {\textstyle \frac in \left(\frac{i+j+1}n\right)^{\gamma-1} }
               && {\textstyle   \frac{j+1}n \left(\frac{i+j+1}n\right)^{\gamma-1}}
         & \\
      \IEEEeqnarrayrulerow\\
      \IEEEeqnarrayseprow[5pt]\\
         & p_2 && {\textstyle 1-\left(\frac{n-l}n\right)^\gamma  }
               && {\textstyle \left(\frac{n-l}n\right)^\gamma-\left(\frac{i+j}n\right)^\gamma }
               && {\textstyle \frac{i-1}n \left(\frac{i+j}n\right)^{\gamma-1} }
               && {\textstyle \frac{j+1}n \left(\frac{i+j}n\right)^{\gamma-1}}
         & \\
      \IEEEeqnarrayrulerow\\
      \IEEEeqnarrayseprow[5pt]\\
         & p_3  && {\textstyle 1-\left(\frac{n-l-1}n\right)^\gamma }
...
\begin{table}
  ...
  \begin{IEEEeqnarraybox*}
    ...
    \IEEEeqnarraystrutsizeadd{2pt}{6pt}]{v/c/v/c/v/c/v/c/v/c/v/}
      ...
      \IEEEeqnarrayseprow[5pt]\\
         & p_0 && {\textstyle 1-\left(\frac{n-l}n\right)^\gamma  }
               && {\textstyle \left(\frac{n-l}n\right)^\gamma-\left(\frac{n-l-1}n\right)^\gamma  }
               && {\textstyle \frac in \left(\frac{n-l-1}n\right)^{\gamma-1}  }
               && {\textstyle \frac{n-l-i-1}n \left(\frac{n-l-1}n\right)^{\gamma-1}}
         & \\
      \IEEEeqnarrayrulerow\\
      \IEEEeqnarrayseprow[5pt]\\
         & p_1 && {\textstyle 1-\left(\frac{n-l}n\right)^\gamma }
               && {\textstyle \left(\frac{n-l}n\right)^\gamma-\left(\frac{n-l-1}n\right)^\gamma }
               && {\textstyle \frac{i-1}n \left(\frac{n-l-1}n\right)^{\gamma-1} }
               && {\textstyle \frac{n-l-i}n \left(\frac{n-l-1}n\right)^{\gamma-1}}
         & \\
      \IEEEeqnarrayrulerow\\
      \IEEEeqnarrayseprow[5pt]\\
         & p_2 && {\textstyle 1-\left(\frac{n-l-1}n\right)^\gamma  }
               && {\textstyle   0  }
               && {\textstyle   \frac in \left(\frac{n-l-1}n\right)^{\gamma-1}  }
               && {\textstyle   \frac{n-l-i-1}n \left(\frac{n-l-1}n\right)^{\gamma-1}}
         & \\
      ...
      \IEEEeqnarrayrulerow\\
      \IEEEeqnarrayseprow[5pt]\\
         & p_4 && {\textstyle 1-\left(\frac{n-l}n\right)^\gamma  }
               && {\textstyle 0  }
               && {\textstyle \frac in \left(\frac{n-l}n\right)^{\gamma-1}  }
               && {\textstyle \frac{n-l-i}n \left(\frac{n-l}n\right)^{\gamma-1}}
         & \\
      \IEEEeqnarrayrulerow
  \end{IEEEeqnarraybox*}
\end{table}}
...
$0\leqslant l\leqslant n-1\qquad\mbox{and}\qquad 1\leqslant i\leqslant n-l-1$
  ...
  \begin{IEEEeqnarraybox*}
    ...
    \IEEEeqnarraystrutsizeadd{2pt}{6pt}]{v/c/v/c/v/c/v/c/v/c/v/}
      ...
      \IEEEeqnarrayrulerow\\
      \IEEEeqnarrayseprow[5pt]\\
         & p_1 && {\textstyle 1-\left(\frac{n-l-1}n\right)^\gamma  }
               && {\textstyle 0  }
               && {\textstyle \frac in \left(\frac{n-l-1}n\right)^{\gamma-1}  }
               && {\textstyle \frac{n-l-i-1}n \left(\frac{n-l-1}n\right)^{\gamma-1}}
         & \\
      ...
      \IEEEeqnarrayrulerow\\
      \IEEEeqnarrayseprow[5pt]\\
         & p_3 && {\textstyle 1-\left(\frac{n-l}n\right)^\gamma  }
               && {\textstyle 0  }
               && {\textstyle \frac{i+1}n \left(\frac{n-l}n\right)^{\gamma-1}  }
               && {\textstyle \frac{n-l-i-1}n \left(\frac{n-l}n\right)^{\gamma-1}}
         & \\
      \IEEEeqnarrayrulerow
  \end{IEEEeqnarraybox*}
\end{table}}
