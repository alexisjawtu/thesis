\def\unifSection{
  \begin{figure}[!ht]
    ...
    \subfloat
    {
      \includegraphics[width=.4\textwidth]{./figures/cylinderUnif.png}
    }
    \caption{Sectional view of a uniform mesh. Prismatic macro--elements.}
    \label{auxlabel212}
  \end{figure}
}
...
\def\gradSection{
  \begin{figure}[!ht]
    ...
    \subfloat
    {
      \includegraphics[width=.7\textwidth]{./figures/cylinderGAMA.png}
    }
    \caption{Sectional view of an anisotropic graded mesh. Prismatic macro--elements.}
    \label{auxlabel310}
  \end{figure}
}
...
\def\conform{
 \begin{figure}[!ht]
    ...
    \subfloat
    {
      \includegraphics[width=.5\textwidth]{./figures/conform11.png}
    }
    \subfloat
    {
      \includegraphics[width=.5\textwidth]{./figures/conform9.png}
    }\\
    \subfloat
    {
      \includegraphics[width=.5\textwidth]{./figures/conform4.png}
    }
    \subfloat
    {
      \includegraphics[width=.5\textwidth]{./figures/conform5.png}
    }
    \caption{Some experiments to show conformity.}
    \label{auxlabel305}
  \end{figure}
}
...
\def\tauOneEnCube{
 \begin{figure}[!ht]
    ...
    \subfloat[n = 1]
    {
      \includegraphics[width=.5\textwidth]{./figures/cube3anim1.png}
    }
    \subfloat[n = 2]
    {
      \includegraphics[width=.5\textwidth]{./figures/cube3anim2.png}
    }\\
    \subfloat[n = 3]
    {
      \includegraphics[width=.5\textwidth]{./figures/cube3anim3.png}
    }
    \subfloat[n = 4]
    {
      \includegraphics[width=.5\textwidth]{./figures/cube3anim4.png}
    }\\
    \subfloat[n = 5]
    {
      \includegraphics[width=.5\textwidth]{./figures/cube3anim5.png}
    }
    \subfloat[n = 6]
    {
      \includegraphics[width=.5\textwidth]{./figures/cube3anim6.png}
    }
    \caption{Cube divided into five tetrahedra.}
    \label{auxlabel301}
  \end{figure}
}
...
\def\tauOneEn{
  \begin{figure}[!ht]
    ...
    \subfloat[n = 2]
    {
      \includegraphics[width=.5\textwidth]{./figures/fichera2.png}
    }
    \subfloat[n = 3]
    {
      \includegraphics[width=.5\textwidth]{./figures/fichera3.png}
    }\\
    \subfloat[n = 4]
    {
      \includegraphics[width=.5\textwidth]{./figures/fichera4.png}
    }
    \subfloat[n = 5]
    {
      \includegraphics[width=.5\textwidth]{./figures/fichera5.png}
    }\\
    \subfloat[n = 6]
    {
      \includegraphics[width=.5\textwidth]{./figures/fichera6.png}
    }
    \subfloat[n = 7]
    {
      \includegraphics[width=.5\textwidth]{./figures/fichera7.png}
    }
    \caption{The Fichera Domain meshed according to Subsection~\ref{meshes}.}
    \label{auxlabel303}
  \end{figure}
}
...
\begin{figure}
  ...
  {
    \label{macro32}
    \includegraphics[width=.325\textwidth]{./figures/test2.png}
  }
  \hspace{1.5cm}
  \subfloat[n = 3]
  {
    \label{macro33}
    \includegraphics[width=.325\textwidth]{./figures/test3.png}
  }\\[3pt]
  \subfloat[n = 4]
  {
    \label{macro34}
    \includegraphics[width=.325\textwidth]{./figures/test4.png}
  }
  \hspace{1.5cm}
  \subfloat[n = 5]
  {
    \label{macro35}
    \includegraphics[width=.325\textwidth]{./figures/test5.png}
  }\\[3pt]
  \subfloat[n = 6]
  {
    \label{macro36}
    \includegraphics[width=.325\textwidth]{./figures/test6.png}
  }
  \hspace{1.5cm}
  \subfloat[n = 7]
  {
    \label{macro37}
    \includegraphics[width=.325\textwidth]{./figures/test7.png}
  }
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=.5\textwidth]{./figures/prismMesh.png}
...
\begin{figure}[!ht]
  \centering
    ...
    \begin{tikzpicture}[scale=.4]
      ...
      \draw (2, 0, 0) -- (0, 3, 0);
      \node[left] at (0,3,0) {$_{_{h_3}}$};
      \draw (0, 3, 0) -- (0,3,1.5) -- (2,0,0); 
      \draw (0,0,0) -- (0,3,1.5);
      \node[left] at (0,0,.85) {$_{_{h_1}}$};
      \draw[->] (0,0,0) -- (0,0,2);
    \end{tikzpicture}
  \caption{Tetrahedra satisfying $\pazocal{MAC}(\nicefrac\pi2)$. The tetrahedron at the right
  satisfies $\pazocal{RVP}(\overline{c})$ with a poor constant $\overline{c}$ close to $0$.}
