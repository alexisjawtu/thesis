...
\begin{IEEEeqnarray*}{rCl}
  \rku & = & \{{\scriptstyle\iint_{\hat{f}_2} \hat\bu \cdot \hat\bn_2\,d\hat S}\}\,\bz_2 + 
         \{{\scriptstyle\iint_{\hat{f}_3} \hat\bu \cdot \hat\bn_3\,d\hat S}\}\,\bz_3\\[4pt]
  ...
  (\rku)_1\xyz & = & -2\alpha_2(\hat\bu) + 
    ...
    & = & -2{\iint_{\hat{f}_2} \hat{\bu} \cdot \hat\bn_2\,d\hat S} + 
          ({\iint_{\hat{f}_2} \hat{\bu} \cdot \hat\bn_2\,d\hat S}+
                  {\iint_{\hat{f}_3} \hat{\bu} \cdot \hat\bn_3\,d\hat S})\frac{2x-xz}{1-z}\\[4pt]
    & = & -2{\iint_{\hat{f}_2} \hat{\bu} \cdot \hat\bn_2\,d\hat S} + 
...
\begin{IEEEeqnarray*}{rCl}
  \rku & = & ({\scriptstyle\iint_{\hat{f}_1} \bu \cdot \hat\bn_1\,d\hat S})\,\bz_1 + 
         \iint_{\hat{f}_4} \bu \cdot \hat\bn_4\,d\hat S\,\bz_4\\[4pt]
...
\begin{IEEEeqnarray*}{rCl}
  \rku & = & ({\scriptstyle\iint_{\hat{f}_3} \bu \cdot \hat\bn_3\,d\hat S})\,\bz_3 + 
         \iint_{\hat{f}_4} \bu \cdot \hat\bn_4\,d\hat S\,\bz_4 + 
         \iint_{\hat{f}_5} \bu \cdot \hat\bn_5\,d\hat S\,\bz_5\\[4pt]
...
\begin{IEEEeqnarray*}{rCl}
  ...
  {\iint_{\hat{f}_3} \bu \cdot \hat\bn_3\,d\hat S} - 
  {\iint_{\hat{f}_4} \bu \cdot \hat\bn_4\,d\hat S} \\[4pt]
...
\begin{IEEEeqnarray*}{rCl}
  ...
  ({\iint_{\hat{f}_3} \bu \cdot \hat\bn_3\,d\hat S} - 
   {\iint_{\hat{f}_4} \bu \cdot \hat\bn_4\,d\hat S})\frac{y}{1-z}.\\[4pt]
    ...
    \IEEEeqnarraystrutsizeadd{2pt}{12pt}]{v/c/v/c/v/c/v/}
        ...
        & (0,0,\hat{u}_3)' & & 
          \begin{IEEEeqnarraybox*}{l}
            ...
            ({\iint_{\hat{f}_3} \bu \cdot \hat\bn_3\,d\hat S}
             \\[5pt] 
             -{\iint_{\hat{f}_4} \bu \cdot \hat\bn_4\,d\hat S})r(x,z)
          \end{IEEEeqnarraybox*}
         & & 
          \begin{IEEEeqnarraybox*}{l}
            y\int_{\hat{E}} \dv\hat{\bu}\,d\hat{\boldsymbol{x}}\\[5pt] +\, 
              ({\iint_{\hat{f}_4} \bu \cdot \hat\bn_4\,d\hat S}
             \\[5pt] 
             -{\iint_{\hat{f}_3} \bu \cdot \hat\bn_3\,d\hat S})r(y,z)
          \end{IEEEeqnarraybox*}
        &\\\IEEEeqnarrayrulerow
    \end{IEEEeqnarraybox*}
\end{table}
