...
in $W^{1,1}(\hat{E})$ which is a space whose elements have well
defined normal traces on each face of the prism $\hat{E}$.
Another possibility, as stated in~\cite{monk}, is to 
assume there are 
...
\begin{IEEEeqnarray*}{rCl}
  ...
  &&\,+ \int\limits_{\hat E} |\hat{u}_3|^p\,d\textbf{x}\\
