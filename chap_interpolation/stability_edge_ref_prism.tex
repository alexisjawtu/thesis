...
by partes over the face $\hat{f}_4$ yields
\noindent{\color{blue}\#\#\#\#\#\#\# CONTINUE HERE} 
\begin{IEEEeqnarray*}{rCl}
	\int\limits_{\hat{f}_4} (\curl\hat{\bu})_3\,\phi\,d\gamma & = &
	\int\limits_{\hat{f}_4} \textbf{curl}(\hat{\textbf{w}})_3\,\phi\,d\gamma\\
	& = & -\int\limits_{\hat{f}_4} \left(w_2\,\partial_x\phi - w_1\,\partial_y\phi\right)\,d\gamma
		+ \int\limits_{\partial \hat{f}_4} \left(w_2\,\nu_x - w_1\,\nu_y\right)\,\phi\,ds\\
	& = &  \int\limits_{\hat{f}_4} w_1\,\partial_y\phi\,d\gamma
