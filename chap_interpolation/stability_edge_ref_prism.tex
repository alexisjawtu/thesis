...
$\varphi_2 = \int_{1-\hat{x}_2}^{\hat{x}_1} 
\hat{r}_2(\hat{t},\hat{x}_2,\hat{x}_3)\,d\hat{t}$, para el cual
vale 
$\partial_x\varphi_2 = \hat{r}_2 $ y $\varphi_2|_{\hat{f}_5} \equiv 0$. Entonces, por partes,
