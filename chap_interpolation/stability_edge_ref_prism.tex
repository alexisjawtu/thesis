...
\end{IEEEeqnarray}
As is now expected, the choice $q = ({\bf curl}\,\wku)_3 |_{\hat{f}}$
...
\begin{IEEEeqnarray}{rCCCCCl} 
  0 & = & \varphi_{\hat f,\boldsymbol{q}}\,(\bu) 
    & = & \varphi_{\hat f,\boldsymbol{q}}\,(\wku) 
    & = & \int\limits_{\hat f} \hat{x}_3\,(\hat{x}_3-1)\hat{p}^2\,d\gamma.
\end{IEEEeqnarray}
...
\end{IEEEeqnarray*}
%    \int\limits_{\hat f} \hat{x}_3\,(\hat{x}_3-1)\hat{p}^2\,d\gamma.
%	\int\limits_{\hat f} (\hat\xi_1)^2\,d\gamma\textrm{,}
sigue que $\rho!! \xi_1|_{f} \equiv 0$. Con todo
...
\end{IEEEeqnarray*}
Resta mirar los degrees of freedom de volumen aplicados a $\pi(\bu)$. Para 
...
\begin{IEEEeqnarray*}{rCCCl}
	\partial_x \pi(\bu)_2 &=& \partial_x \xi_2 &\equiv& 0\textrm{,}
\end{IEEEeqnarray*}
