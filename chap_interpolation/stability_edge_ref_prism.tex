...
\begin{IEEEeqnarray}{rCl}\label{momentosWcaras}
 	\nonumber\int\limits_{\hat{f}_3} \hat{\textbf{w}} \times \boldsymbol{\nu} \cdot \bq\,d\hat{\gamma}
...
\begin{IEEEeqnarray}{rCl}\label{momentosWcaras2}
 	\nonumber\int\limits_{\hat{f}_4} \hat{\textbf{w}} \times \boldsymbol{\nu} \cdot \boldsymbol{\phi}\,d\hat{\gamma}
 		& = & \int\limits_{\hat{f}_4} u_1\,\phi_2\,d\hat{\gamma} - \int\limits_{\hat{f}_4} \textbf{curl}(\hat{\bu})_3\,\varphi_1\,d\hat{\gamma}\\
 		& 	& + \int\limits_{\hat{f}_4} u_1\,\partial_y\varphi_1\,d\hat{\gamma}	+ \int\limits_{\hat{\be}_4} u_1\,\nu_y\,\varphi_1\,ds\textrm{,}
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{rCl}\label{momentosWcaras3}
 	\nonumber\int\limits_{\hat{f}_4} \hat{\textbf{w}} \times \boldsymbol{\nu} \cdot \textbf{q}\,d\gamma
 		& = & \int\limits_{\hat{f}_5} u_1\,q_1\,d\gamma + \int\limits_{\hat{f}_5} \textbf{curl}(\hat{\bu})_3\,\varphi_1\,d\gamma\\
 		& 	& - \int\limits_{\hat{f}_5} u_1\,\partial_y\varphi_1\,d\gamma	+ \int\limits_{\hat{\be}_4} u_1\,\varphi_1\,ds.
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{rCl}\label{momentosWvolumen}
 	\nonumber\int\limits_{\hat{K}} \hat{\textbf{w}} \cdot \boldsymbol{\phi}\,d\textbf{x}
 		...
 		\int\limits_{\hat{f}_2} u_1\,\varphi_2\,d\gamma.
