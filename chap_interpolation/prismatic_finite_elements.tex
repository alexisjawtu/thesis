...
{\color{blue}\#\#\#\#\#\#\#\# continue here. seguir en la linea con ***********.}
...
\begin{IEEEeqnarray}{rCl}
  ...
  \right\|_{L^p(\tilde E)}\\[5pt]
  \label{aux_label25}
  {\color{BrickRed}
  \|\frac{\partial}{\partial_{\tilde x_j}}\curl(\tilde\bu-\tilde\bq)_i\|_{L^p(\tilde E)}}&\leqslant&
    C\,h^{m-1}
    \|\partial^m(\curl\tilde\bu)_i\|_{L^p(\tilde E)}
\end{IEEEeqnarray}
