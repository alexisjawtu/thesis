...
\begin{IEEEeqnarray*}{rCl}
  ...
  y \iint_{{\hat f_5}}\frac{{\s\partial} u_1}{{\s\partial} x_2}\,dS\ok\\
    &&\,
+\frac{yz}{1-z} \iint_{\hat f_3} \frac{{\s\partial} u_1}{{\s\partial} x_2}\,dS\ok +
 \frac{yz}{1-z} \iint_{\hat f_4} \frac{{\s\partial} u_2}{{\s\partial} x_1}\,dS\ok\\
    &&\,
-\frac{yz}{1-z} \int\limits_{\hat{E}}\frac{{\s\partial}^2u_3}{{\s\partial} x_2{\s\partial} x_1}\,d\hat\bx\ok.
\end{IEEEeqnarray*}
%%==========================================================================
%{\color{brown}
%    \begin{IEEEeqnarray*}{rCl}
...
%        \frac{{\s\partial} u_1}{{\s\partial} x_3}(t_1,0,t_2)\,dt_2dt_1 \ok+
%        y \int_{{\hat f_5}}
%        \frac{{\s\partial} u_1}{{\s\partial} x_2}\,dS\ok\\
...
%        &&\,-z\int\limits_0^1\int\limits_0^{1-t_1}
%        \frac{{\s\partial} u_3}{{\s\partial} x_1}(t_1,0,t_2)\,dt_2dt_1 \ok-
%        \frac{yz}{1-z} \int\limits_{\hat{E}}
