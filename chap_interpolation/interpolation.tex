...
\begin{table}[!h]
    ...
    \begin{IEEEeqnarraybox*}
      ...
      \IEEEeqnarraystrutsizeadd{2pt}{6pt}]{v/c/x/c/x/c/x/v/x/c/x/c/x/c/v/}
        ...
        \IEEEeqnarrayseprow[5pt]\\
   & 
   \hat \be_1 && = && \{(\hat x_1,0,0)^t\,:\,0\leqslant\hat x_1\leqslant 1\} && &&
   \hat \be_5 && = && \{(0,\hat x_2,1)^t\,:\,0\leqslant\hat x_2\leqslant 1\} & \\
        \IEEEeqnarrayrulerow\\
        \IEEEeqnarrayseprow[5pt]\\
   & 
   \hat \be_2 && = && \{(0,\hat x_2,0)^t\,:\,0\leqslant\hat x_2\leqslant 1\} && &&
   \hat \be_6 && = && \{(1,0,\hat x_3)^t\,:\,0\leqslant\hat x_3\leqslant 1\} & \\
        \IEEEeqnarrayrulerow\\
        \IEEEeqnarrayseprow[5pt]\\
   &
   \hat \be_3 && = && \{(0,0,\hat x_3)^t\,:\,0\leqslant\hat x_3\leqslant 1\} && &&
   \hat \be_7 && = && \{(0,1,\hat x_3)^t\,:\,0\leqslant\hat x_3\leqslant 1\} & \\
        \IEEEeqnarrayrulerow\\
        \IEEEeqnarrayseprow[5pt]\\
   & 
\hat \be_4 && = && \{(\hat x_1,0,1)^t\,:\,0\leqslant\hat x_1\leqslant 1\}
&& && 
\hat \be_8 && = && \{(\hat x_1,1-\hat x_1,1)^t\,:\,0\leqslant\hat x_1\leqslant 1\} & \\
        \IEEEeqnarrayrulerow\\
    &\IEEEeqnarraymulticol{13}{c}{
      \raisebox{-3pt}[0pt][0pt]{
        $\hat \be_9 =  \{(\hat x_1,1-\hat x_1,0)^t\,:\,0\leqslant\hat x_1\leqslant 1\}$
      }
    }&\\
      \IEEEeqnarrayrulerow
    \end{IEEEeqnarraybox*}
...
\begin{table}[!h]
    ...
    \begin{IEEEeqnarraybox*}
      [\IEEEeqnarraystrutmode
      \IEEEeqnarraystrutsizeadd{2pt}{6pt}]{v/c/x/c/x/c/v/c/x/c/x/c/v/}
        \IEEEeqnarrayrulerow\\
        \IEEEeqnarrayseprow[5pt]\\
...
\noindent{\color{blue}\#\#\#\#\#\#\# continue here stab curl pyr} 
