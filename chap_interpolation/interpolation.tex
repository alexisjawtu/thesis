...
There is $C > 0$, independent of $h_1$, $h_2$ and $h_3$, s.t. for all $p \geqslant 1$ and 
  ...
  \begin{IEEEeqnarray*}{rCl}
    ...
    + h_{\tilde{E}}\left\|\mathit{\Div}(\tilde{u}_1, \tilde{u}_2, 0) \,\right\|_{L^p(\tilde{E})}\right).
  \end{IEEEeqnarray*}
\end{theorem}
\begin{proof}
...
\begin{IEEEeqnarray*}{rClCrClCrCl}
  \hat f_1 & \subseteq &  \{\hat x_2 = 0 \} & \qquad & \hat \be_1& = & \{(\hat x_1,0,0)^t\,:\,0\leqslant\hat x_1\leqslant 1\}  &\quad& \hat \be_6& = & \{(1-\hat x_3,0,\hat x_3)^t\,:\,0\leqslant\hat x_3\leqslant 1\} \\[4pt]
  \hat f_2 & \subseteq &  \{\hat x_1 = 0      \} & \qquad & \hat \be_2& = & \{(1,\hat x_2,0)^t\,:\,0\leqslant\hat x_2\leqslant 1\}  &\quad& \hat \be_7& = & \{(0,1-\hat x_3,\hat x_3)^t\,:\,0\leqslant\hat x_3\leqslant 1\} \\[4pt]
  \hat f_3 & \subseteq &  \{\hat x_1 + \hat x_3 = 1      \} & \qquad & \hat \be_3& = & \{(\hat x_1,1,0)^t\,:\,0\leqslant\hat x_1\leqslant 1\}  &\quad& \hat \be_8& = & \{(1-\hat x_3,1-\hat x_3,\hat x_3)^t\,:\,0\leqslant\hat x_3\leqslant 1\} \\[4pt]
  \hat f_4 & \subseteq &  \{\hat x_1 + \hat x_2 = 1      \} & \qquad & \hat \be_4& = & \{(0,\hat x_2,0)^t\,:\,0\leqslant\hat x_2\leqslant 1\}  &\quad&  &  & \\[4pt]
  \hat f_5 & \subseteq &  \{\hat x_3 = 0\}  & \qquad & \hat \be_5& = & \{(0,0,\hat x_3)^t\,:\,0\leqslant\hat x_3\leqslant 1\}  &     &           &           &
\end{IEEEeqnarray*}
...
\paragraph{Stability $\hat{P}$ {\color{red}Estamos usando las shapes
de~\cite{gh99} p.164, que verifiqu\'e que son las correctas.}}
\label{par:stability_hat}
\begin{IEEEeqnarray*}{rCl}
{\color{blue} \boldsymbol{p>1}}?? & & \\
  \|(\pi\bu)_1\|_{\scriptscriptstyle{L^\infty}} & \lesssim & 
    \|u_1\|_{\scriptscriptstyle{L^p}} +
    \|\Div \bu\|_{\scriptscriptstyle{L^p}} + 
    \sum_{\scriptscriptstyle{1\leqslant i\leqslant 3}} 
    \left\|\dfrac{{\scriptstyle\partial} u_1}{{\scriptstyle\partial} x_i}\right\|_{\scriptscriptstyle{L^p}}\\[7pt]
  & &\,   + \left\|\dfrac{{\scriptstyle\partial} u_3}{{\scriptstyle\partial} x_1}\right\|_{\scriptscriptstyle{L^p}}
      + \left\|\dfrac{{\scriptstyle\partial} u_3}{{\scriptstyle\partial} x_2}
        \right\|_{\scriptscriptstyle{L^p}} + \left\|\dfrac{{\scriptstyle\partial} u_2}{{\scriptstyle\partial} x_2}
        \right\|_{\scriptscriptstyle{L^p}}\\[7pt]
  &\eqsim& \|u_1\|_{\scriptscriptstyle{W^{1,p}}} +
    \|\Div \bu\|_{\scriptscriptstyle{L^p}} + \left\|\dfrac{{\scriptstyle\partial} u_3}{{\scriptstyle\partial} x_1}\right\|_{\scriptscriptstyle{L^p}}
      + \left\|\dfrac{{\scriptstyle\partial} u_3}{{\scriptstyle\partial} x_2}
        \right\|_{\scriptscriptstyle{L^p}} + \left\|\dfrac{{\scriptstyle\partial} u_2}{{\scriptstyle\partial} x_2}
        \right\|_{\scriptscriptstyle{L^p}}.\\[12pt]
  \|(\pi\bu)_3\|_{\scriptscriptstyle{L^\infty}} & \lesssim & 
    \|u_3\|_{\scriptscriptstyle{L^p}} +
    \|\Div \bu\|_{\scriptscriptstyle{L^p}} +
    \sum_{\scriptscriptstyle 1\leqslant i\leqslant 3}
      \left\|\dfrac{{\scriptstyle\partial} u_3}{{\scriptstyle\partial} x_i}
    \right\|_{\scriptscriptstyle{L^p}}
\end{IEEEeqnarray*}
