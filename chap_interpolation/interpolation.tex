...
\begin{figure}[!h]
  ...
  \caption{Directions of positive unit tangents.}
\end{figure}
...
\begin{figure}
  \includegraphics[width=\textwidth]{./figures/20170708_110423.jpg}
\end{figure}
\begin{table}[!h]
    \centering  
    \caption{Notation for the faces and positive normals of $\partial\hat{E}$.}
...
\caption{Directions of the positive unit tangents.}
