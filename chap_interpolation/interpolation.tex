...
\|\bu_I\|_{L^1(P)} \le C\Bigg(\|\bu\|_{L^1(P)} + \sum_{i=1}^3 h_{i,P}\|\partial_{\xi_{P,i}}\bu\|_{L^1(P)}\\ + \max\{h_{P,1},h_{P,2}\}\|\mbox{div\,}(u_1,u_2,0)\|_{L^1(P)}\Bigg).
\end{multline}
\end{lemma}
...
\end{eqnarray*}
Then the proof concludes by noting that $\|B\|\le C$ and $\|B^{-1}\|\sim \sin\alpha_P$.
\end{proof}
...
\|\bu_I\|_{L^2(P)} \le C\Bigg(\|\bu\|_{L^2(P)} + \sum_{i=1}^3 h_{i,P}\|\partial_{\xi_{P,i}}\bu\|_{L^2(P)}\\ + \max\{h_{P,1},h_{P,2}\}\|\mbox{div\,}(u_1,u_2,0)\|_{L^2(P)}\Bigg)
\end{multline}
\end{remark}
...
\|\bu_I\|_{L^p(P)} \le \left(\|\bu\|_{L^p(P)} + \sum_{i=1}^3 h_{P,i}\|\partial_{\xi_i} \bu\|_{L^p(P)}+ h_K\|\mbox{div\,}\bu\|_{L^p(P)}\right)
\end{equation}
\end{corollary}
\begin{remark}
