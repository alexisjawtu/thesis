...
Then
\begin{IEEEeqnarray*}{rCl}
  \|(\rku)_3\|_L & \leqslant & c(\hat{E}) \left\{
   \sum_{j=3,6,7\,p\,\in\,{\color{red}\mathcal{B}_{\hat e_j}}}
  \int\limits_{\hat e_j} |\hat{u}_3|\,ds +
  \sum_{i=1,2,4\,q\,\in\,{\color{red}\mathcal{B}_{\hat f_i}}}
  \int\limits_{\hat f_i} |\hat{u}_3|\,d\gamma
  \right.\\ 
  &&\left.\,+\sum_{\boldsymbol{r}\,\in\,{\color{red}\mathcal{B}_{\hat E}}}
  \int\limits_{\hat E} |\hat{u}_3|\,d\textbf{x}
  \right\}\\
  &\leqslant& c(\hat{E}) \noindent{\color{blue}\#\#\#\#\#\#\# \mbox{continue here and 
  then in stab-edge-tilde-prims.tex}}  
\end{IEEEeqnarray*}
...
% subsection stability_of_div_elements_in_hat_prisms (end)
