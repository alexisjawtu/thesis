...
\begin{table}[!h]
    ...
    \begin{IEEEeqnarraybox*}
      ...
      \IEEEeqnarraystrutsizeadd{2pt}{6pt}]{v/c/x/c/x/c/x/v/x/c/x/c/x/c/v/}
        \IEEEeqnarrayrulerow\\
        \IEEEeqnarrayseprow[5pt]\\
   & \hat \be_1 && = && \{(\hat x_1,0,0)^t\,:\,0\leqslant\hat x_1\leqslant 1\} && && \hat \be_5 && = && \{(0,0,\hat x_3)^t\,:\,0\leqslant\hat x_3\leqslant 1\} & \\
        \IEEEeqnarrayrulerow\\
        \IEEEeqnarrayseprow[5pt]\\
   & \hat \be_2 && = && \{(1,\hat x_2,0)^t\,:\,0\leqslant\hat x_2\leqslant 1\} && && \hat \be_6 && = && \{(1-\hat x_3,0,\hat x_3)^t\,:\,0\leqslant\hat x_3\leqslant 1\} & \\
        \IEEEeqnarrayrulerow\\
        \IEEEeqnarrayseprow[5pt]\\
   & \hat \be_3 && = && \{(\hat x_1,1,0)^t\,:\,0\leqslant\hat x_1\leqslant 1\} && && \hat \be_7 && = && \{(0,1-\hat x_3,\hat x_3)^t\,:\,0\leqslant\hat x_3\leqslant 1\} & \\
        \IEEEeqnarrayrulerow\\
        \IEEEeqnarrayseprow[5pt]\\
   & \hat \be_4 && = && \{(0,\hat x_2,0)^t\,:\,0\leqslant\hat x_2\leqslant 1\} && && \hat \be_8 && = && \{(1-\hat x_3,1-\hat x_3,\hat x_3)^t\,:\,0\leqslant\hat x_3\leqslant 1\} & \\
        \IEEEeqnarrayrulerow
    \end{IEEEeqnarraybox*}
\end{table}
...
\begin{IEEEeqnarray*}{rCl}
  ...
  &\lesssim& \|u_1\|_{\scriptscriptstyle{W^{1,p}(\hat{E})}} +
    \|\dv \bu\|_{\scriptscriptstyle{L^p}(\hat{E})} + \left\|\dfrac{{\scriptstyle\partial} u_3}{{\scriptstyle\partial} x_1}\right\|_{\scriptscriptstyle{L^p}(\hat{E})}
      + \left\|\dfrac{{\scriptstyle\partial} u_3}{{\scriptstyle\partial} x_2}
        \right\|_{\scriptscriptstyle{L^p}(\hat{E})} + {\color{red}\mbox{se iria}\left\|\dfrac{{\scriptstyle\partial} u_2}{{\scriptstyle\partial} x_2} 
  ...
  &\lesssim& \|u_2\|_{\scriptscriptstyle{W^{1,p}(\hat{E})}} +
    ...
    \left\|\dfrac{{\scriptstyle\partial} u_3}{{\scriptstyle\partial} x_2}
      \right\|_{\scriptscriptstyle{L^p}(\hat{E})} + 
    {\color{red}\mbox{se iria! sacar tambien de la charla de chile}\left\|\dfrac{{\scriptstyle\partial} u_1}{{\scriptstyle\partial} x_1}
            \right\|_{\scriptscriptstyle{L^p}(\hat{E})}}.\\[12pt]
...
\end{IEEEeqnarray*}
By Theorem 3.9 in~\cite{monk}, page 43,
\begin{IEEEeqnarray*}{rCl}
  \left|\iint_{\hat{f}_3} \hat{u}_3\,d\gamma - \iint_{\hat{f}_4} \hat{u}_3\,d\gamma\right| 
  & \leqslant & 2^{-1/4}\,[\,\|\mbox{Tr}_{\hat{f}_3}\hat{u}_3\|_{L^2(\hat{f}_3)}+
                             \|\mbox{Tr}_{\hat{f}_4}\hat{u}_3\|_{L^2(\hat{f}_4)}\,] \\[5pt]
  & \leqslant & C\,\|\mbox{Tr\,}\hat{u}_3\|_{H^{\delta}(\partial\hat{E})} \\[5pt]
  & \leqslant & C\,\|\hat{u}_3\|_{H^{1/2+\delta}(\hat{E})}.
\end{IEEEeqnarray*}
