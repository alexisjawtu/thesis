...
There is $C > 0$, independent of $h_1$, $h_2$ and $h_3$, s.t. for all $p \geqslant 1$ and 
  ...
  \begin{IEEEeqnarray*}{rCl}
    \left\| \tilde{\br}_k\,\tilde{\bu}\right\|_{L^p(\tilde{E})}
    & \leqslant & C \left( \left\| \tilde{\bu} \right\|_{L^p(\tilde{E})}
    + \sum_{i=1}^3 h_i \left\| \partial_{\tilde{x}_i}\tilde{\bu} \right\|_{L^p(\tilde{E})}
...
\begin{IEEEeqnarray*}{rCl}
  \|(\tilde{\br}_k\tilde{\boldsymbol{u}})_1\|_{L^{\infty}(\tilde{E})} & = &
  \frac{1}{h_2h_3}
  \|(\hat{\br}_k\hat{\boldsymbol{u}})_1\|_{L^{\infty}(\hat{K})}\\[7pt]
  ...
  &=&\frac{1}{\det F}\left(
  \int\limits_{\tilde{E}}|\tilde{u}_1|\,d\tilde{\textbf{x}}
  +\sum_{i=1}^3h_i\int\limits_{\tilde{E}}|\partial_{\tilde{x}_i}\tilde{u}_1|\,d\tilde{\textbf{x}}
  +h_1\int\limits_{\tilde{E}}|\partial_{\tilde{x}_1}\tilde{u}_1 + \partial_{\tilde{x}_2}\tilde{u}_2|
  \,d\tilde{\textbf{x}}\right)\\[7pt]
  &=&\frac{1}{2|\tilde{E}|}\left(
  \|\tilde{u}_1\|_{L^1(\tilde{E})}
  +\sum_{i=1}^3h_i\|\partial_{\tilde{x}_i}\tilde{u}_1\|_{L^1(\tilde{E})}
  +h_1\|\dvg(\tilde{u}_1,\tilde{u}_2,0)\|_{L^1(\tilde{E})}\right)\\[7pt]
  &\leqslant&\frac{1}{2|\tilde{E}|^{\frac{1}{p}}}\left(
  \|\tilde{u}_1\|_{L^p(\tilde{E})}
  +\sum_{i=1}^3h_i\|\partial_{\tilde{x}_i}\tilde{u}_1\|_{L^p(\tilde{E})}
  +h_1\|\dvg(\tilde{u}_1,\tilde{u}_2,0)\|_{L^p(\tilde{E})}\right)
\end{IEEEeqnarray*}
Now
\begin{IEEEeqnarray*}{rCl}
  \|(\tilde{\br}_k\tilde{\boldsymbol{u}})_1\|_{L^{p}(\tilde{E})}
  &\leqslant&
...
\begin{IEEEeqnarray*}{rCl}
  \|(\tilde{\br}_k\tilde{\boldsymbol{u}})_3\|_{L^{\infty}(\tilde{E})} & = &\frac{1}{h_1h_2}
  \|(\hat{\br}_k\hat{\boldsymbol{u}})_3\|_{L^{\infty}(\hat{K})}\\[6pt]
  &\leqslant&\frac{C}{h_1h_2}\,\|\hat{u}_3\|_{W^{1,1}(\hat{K})}\\[6pt]
  &=&\frac{C}{|\tilde{E}|}\,\left[\|\tilde{u}_3\|_{L^1(\tilde{E})} +
    \sum_{i=1,2,3} h_i\,\|\partial_{\tilde{x}_i}\tilde{u}_3\|_{L^1(\tilde{E})}\right]\\[6pt]
  &\leqslant& \frac{C}{|\tilde{E}|^{\frac{1}{p}}}\,\left[\|\tilde{u}_3\|_{L^p(\tilde{E})} +
    \sum_{i=1,2,3} h_i\,\|\partial_{\tilde{x}_i}\tilde{u}_3\|_{L^p(\tilde{E})}\right],
\end{IEEEeqnarray*}
for any real $p \geqslant 1$. So, immediately,
\begin{IEEEeqnarray*}{rCl}
  \|(\tilde{\br}\tilde{\boldsymbol{u}})_3\|_{L^{p}(\tilde{E})}
  &\leqslant& C\,\left(
  \|\tilde{u}_3\|_{L^p(\tilde{E})} +
    \sum_{i=1,2,3} h_i\,\|\partial_{\tilde{x}_i}\tilde{u}_3\|_{L^p(\tilde{E})}
  \right)
\end{IEEEeqnarray*}
