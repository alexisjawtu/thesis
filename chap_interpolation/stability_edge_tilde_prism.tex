...
~(\ref{piTransformado}) that $(\wkutilde)_1 = 
\nicefrac{1}{h_1} (\wku)_1$. By~(\ref{teorema_1}) and a suitable, though elementary,
...
\begin{IEEEeqnarray*}{rCl}
  ...
  \right].
\end{IEEEeqnarray*}
With respect to component number three
\begin{IEEEeqnarray*}{rCl}
...
$\tilde{\bu}\in\wpcurl{\tilde{E}}$
    \begin{IEEEeqnarray*}{rCl}
        ...
        & & \left.
        \:+\;h\left\|(\curl\,\tilde{\bu})_3 \right\|_{L^p(\tilde{E})}
        + h\sum_{i=1}^3 h_i
        \left\| \partial_{\tilde{x}_i}(\curl\,\tilde{\bu})_3 \right\|_{L^p(\tilde{E})}
    \right].
    \end{IEEEeqnarray*}
\end{theorem}
...
\begin{proof}
    ...
    \begin{IEEEeqnarray*}{rCl}
        \|(\curl\,\tilde{\textbf{u}})_3\|_{L^1(\tilde{E})} &\leqslant&
         |\tilde{E}|^{1-\frac{1}{p}}\,\|(\curl\,\tilde{\textbf{u}})_3\|_{L^p(\tilde{E})}\\
        \|\partial_{\tilde{x}_i}(\curl\,\tilde{\textbf{u}})_3\|_{L^1(\tilde{E})} &\leqslant&
         |\tilde{E}|^{1-\frac{1}{p}}\,\|\partial_{\tilde{x}_i}(\curl\,\tilde{\textbf{u}})_3\|_{L^p(\tilde{E})}.
    \end{IEEEeqnarray*}
    So we get to
    \begin{IEEEeqnarray*}{rCl}
