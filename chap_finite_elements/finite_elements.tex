...
\begin{IEEEeqnarray}{rCl}\label{edge_interp_explicit}  
  \hat{\boldsymbol{w}}_k\hat{\bu} & = & \sum_{e,p} \varphi_{e,p}(\hat{\bu})\,\hat{\bv}_{e,p} +
                                        \sum_{f,q} \varphi_{f,q}(\hat{\bu})\,\hat{\bv}_{f,q} +
...
\begin{IEEEeqnarray}{lcl}
    \label{momentos1hdiv} \int\limits_{f} (\boldsymbol{v}\cdot\boldsymbol{\nu})q\,d\gamma 
        && \mbox{for } q \in P_{k-1}(x,y):=\mathcal{P}_f\mbox{,}\\
...
\begin{IEEEeqnarray}{rCl}\label{face_interp_explicit}  
  \hat{\boldsymbol{r}}_k\hat{\bu} & = & \sum_{f,q} \varphi_{f,q}(\hat{\bu})\,\hat{\bv}_{f,q} +
                                        \sum_{r}   \varphi_{r}  (\hat{\bu})\,\hat{\bv}_{r}
\end{IEEEeqnarray}
\end{remark}
