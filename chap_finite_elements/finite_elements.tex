...
\begin{IEEEeqnarray}{ll}
    ...
    \label{momentos6hcurl} \int\limits_{K} \textbf{u} \cdot \br \, d\textbf{x}\mbox{, }&\\
...
\begin{IEEEeqnarray}{rCl}\label{face_interp_explicit}  
  \hat{\boldsymbol{r}}_k\hat{\bu} & = & \sum_{f,\bq} \varphi_{f,\bq}(\hat{\bu})\,\hat{\bv}_{f,\bq} +
