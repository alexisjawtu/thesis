...
\begin{table}[!h]
    \centering  
    \caption{\emph{Shape functions} en $\hat{E}$}
...
\begin{table}[!h]
    ...
    \IEEEeqnarraystrutsizeadd{2pt}{25pt}]{x/c/x/c/x/c/x}
        ...
        &\IEEEeqnarraymulticol{5}{c}{
                \raisebox{-15pt}{}\;\;
                {%\tiny
                {\scriptstyle\boldsymbol{\zeta}_1} = 
                \left(
                            \begin{array}{c}
                                -\frac{xz}{1-z} \\[8pt]             
                                y-2+\frac{y}{1-z} \\[8pt]
                        ...
                        \right)}\;\;
                {%\tiny
                {\scriptstyle\boldsymbol{\zeta}_2} = 
                \left(
                            \begin{array}{c}
                                x-2+\dfrac{x}{1-z} \\[8pt]
                                -\dfrac{yz}{1-z} \\[8pt]                
        ...
        &
        {%\tiny
        {\scriptstyle\boldsymbol{\zeta}_3} = 
        \left(
                    \begin{array}{c}
                        x+\dfrac{x}{1-z} \\[8pt]
                        -\dfrac{yz}{1-z} \\[8pt]                
                ...
                \right)}&&
        {%\tiny
        {\scriptstyle\boldsymbol{\zeta}_4} = 
        \left(
                    \begin{array}{c}
                        -\dfrac{xz}{1-z} \\[8pt]                
                        y+\dfrac{y}{1-z} \\[8pt]
                ...
                \right)}&&
        {%\tiny
        {\scriptstyle\boldsymbol{\zeta}_5} = 
        \left(
                    \begin{array}{c}
                        x \\[8pt]               
                        y \\[8pt]
...
\begin{itemize}
    ...
    \item El espacio $Q_{\hat{E}}$ is $\mbox{span}\{\hat{\boldsymbol{\zeta}}_1,\,\ldots,\,\hat{\boldsymbol{\zeta}}_5\}$ with $\hat{\boldsymbol{\zeta}}_i$
    as in Table~(\ref{table_face_func_pyramid})
    \item The degrees of freedom are:
\begin{IEEEeqnarray}{lcl}
