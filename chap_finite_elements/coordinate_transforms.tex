...
\begin{IEEEeqnarray}{ll}
    ...
    \int_{\be} q\,\bu \cdot d\balpha  
        ...
        &\quad  \nonumber\mbox{ for each edge $\be$; }\\[8pt]
    \label{momentos2hcurlPhys} 
    \varphi_{f,\bq}\,(\bu) =  
    \int_{f} \bu \cdot \bq_0\,
    dS\mbox{, } &\quad \bq_0 = (\det M_E\|M_E^{-t}\hat\bn\|)^{-1} M_E\,\hat{\bq}_T\\
    &\quad \hat{\bq}_T := (\hat\bn\times\hat\bq)\times\hat\bn\\
...
\end{IEEEeqnarray}
Provided $\det M_E > 0$, the degrees of freedom are identical.
\end{lemma}
\begin{proof}
...
of $H(\bcurl)$--conforming and unisolvent finite elements.
\end{corollary}
\begin{proof}
