...
\begin{IEEEeqnarray}{ll}
    ...
    \hat\varphi_{\hat{\be}_i,p}\,(\hat\bu) = 
    \int_{\hat\be} \hat q\,\hat\bu\cdot d\hat\balpha  
        & \hat q\in P_{k-1}(\hat\be)\mbox{,} \\
    \IEEEeqnarraymulticol{2}{l}{\nonumber\mbox{ for each edge $\hat\be$}\mbox{;}}\\[8pt]%with unit tangent } \boldsymbol{\tau} \mbox{;}}\\[8pt]
...
If we take the solution (u,p) in Problem (put ref)
the singular part of the vectorial 
 has a well defined interpolate.
