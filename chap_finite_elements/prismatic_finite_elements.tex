...
\end{IEEEeqnarray*}
\begin{defi}\label{defi_h_div_conforme} Given a non--negative integer $k$,
...
\begin{IEEEeqnarray}{cCccl}
    \label{momentos1hdiv} 
    \hat\rho_{\hat f,\hat q}(\hat\bv) & = & \iint_{\hat f} (\hat\bv\cdot\hat{\bn})\hat{q}\,d\hat{S} 
...
\begin{example}[edge elements of lowest order.]
\begin{IEEEeqnarray*}{rCl}
\hat{\bu}\,\xyz &=& 
\left(
    \begin{array}{c}
