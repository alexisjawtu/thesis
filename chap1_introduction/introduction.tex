...
physical object is Anisotropic 

Meshes are said to be anisotropic if... the definition is in 
Chapter~\ref{auxlabel207}.

In several situations in mixed finite element approximations the use of meshes 
with anisotropic elements is needed. This is the case for instance when dealing with
...
With these two notions in mind we need to start with the following results from~\cite{aadl}.
