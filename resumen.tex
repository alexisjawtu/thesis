...
distintas situaciones en aproximaciones por elementos finitos mixtos
...
\begin{equation*}\label{auxlabel425} 
\left\{\begin{array}{rcll}
	\boldsymbol{u}&=&-\nabla p& \mbox{en }\Omega\\
	\dv\boldsymbol{u}&=&f& \mbox{en }\Omega\\
	p&=&0&\mbox{en }\partial\Omega.\end{array}
\right.
\end{equation*}
En este caso la variable vectorial de la soluci\'on, $\boldsymbol{u}$,
no est\'a en $H^1(\Omega)$ en el caso ge\-ne\-ral debido a las singularidades 
...
elementos arbitrariamente alargados en la direcci\'on de las aristas singulares.
