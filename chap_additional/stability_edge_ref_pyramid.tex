...
\begin{IEEEeqnarray}{rCl}
  ...
  \|(\nabla\times\hat\bu)_3\|_{\scriptscriptstyle W^{1,1}(\hat E)}\\
  &&\, +  \left\|\tfrac{\partial \hat u_1}{\partial\hat x_2}\right\|_{W^{1,1}(\hat E)} +
          \left\|\tfrac{\partial^2 \hat u_3}{\partial\hat x_2\partial\hat x_1}\right\|_{W^{1,1}(\hat E)}.\\
  \|(\wku)_2\|_{L^\infty(\hat E)}&\lesssim&
\|\hat u_2\|_{\scriptscriptstyle W^{1,p}(\hat E)} +
  \|(\nabla\times\hat\bu)_1\|_{\scriptscriptstyle W^{1,1}(\hat E)} +  
  \|(\nabla\times\hat\bu)_3\|_{\scriptscriptstyle W^{1,1}(\hat E)}\\
  &&\, +  \left\|\tfrac{\partial \hat u_2}{\partial\hat x_1}\right\|_{W^{1,1}(\hat E)} +
          \left\|\tfrac{\partial^2 \hat u_3}{\partial\hat x_2\partial\hat x_1}\right\|_{W^{1,1}(\hat E)}.\\
  \|(\wku)_3\|_{L^\infty(\hat E)}&\lesssim&C\,\left\{  \right\}
\end{IEEEeqnarray}
\end{theorem}
\begin{proof}
...
what was obtained in~(\ref{first_a})--(\ref{third_c}), then it holds
\begin{IEEEeqnarray*}{rCl}
  (\wku)_1 & = & 
