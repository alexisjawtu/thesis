...
\end{proof}
\begin{lemma}\label{auxlabel500} Let $\hat\bu\in W^{1,p}(\hat{E})$ for $p>2$.
\begin{itemize}
...
If $\hat\bu$ is of the form 
\[
  \hat{\bu}\xyz=(0,0,\hat{u}_3\xyz)^t\mbox{,}
\]
then $\wku$ is of the form
\[
  \wku\xyz = (0,0,\hat\xi_3\xyz)^t
\]
for some
...
and let $\hat\varphi_2$ be defined by
\[
...
To prove~(\ref{teorema_3}), given $\hat{\bu} \in W^{1,p}(\hat{E})^3$, define
$\hat{\bv}  =  (0,0, \hat{u}_3)'.$
