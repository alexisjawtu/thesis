\section{Anisotropic Local interpolation Estimates 
for Pyramidal Finite Elements} % (fold)
...
% subsection edge_elements (end)1
\subsection{Anisotropic Interpolation Estimates for $H(\text{div})$ conforming 
Elements on Pyramids} % (fold)
...
\begin{table}[!h]
    \centering  
    \caption{Terms in the proof of Theorem~\ref{aux_label54}.\\[4pt]$q(s,t) = \tfrac{2s-st}{1-t},\,r(s,t) = \tfrac{st}{1-t}$}
    \label{terms_table}
