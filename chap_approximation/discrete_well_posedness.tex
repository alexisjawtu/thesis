...
$H(\Div)$--conforming operators~(\ref{sub:definition_of_the_h_div_element_on_prisms})
...
piecewise in $W(E)$ that we will use on the right of~(\ref{aux_label48})  and~(\ref{aux_label49}).
