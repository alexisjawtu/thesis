...
\end{eqnarray*}
Now let $\Tb$ be the family of triangles with vertices
...
\begin{proposition} The pyramids and tetrahedra in the meshes defined in Subsection~\ref{meshes}  are isotropic.
\end{proposition}
