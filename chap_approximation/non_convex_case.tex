...
%%=========== GRADING ==============================================
Our algorithm starts taking a first mesh of macro--elements, which may be
prismatic or tetrahedral, according to the main regularity result, 
Theorem~\ref{thm_regularity}.
Read Section~\ref{sec:regularity} again and recall Figures~\ref{macro_prism_reg}  
and~\ref{macro_tetra_reg}.

We show that, in each prismatic or tetrahedral macro--element, our meshes
...
\end{IEEEeqnarraybox*}
\end{equation}
with $\mu\leqslant 1-\delta$ for $\delta>1-\lambda_{\be}$.\\
with $\nu\leqslant 1-\beta$ for $\beta>\frac12-\lambda_{\bv}$.
%%==================================================================
\subsubsection{Macro--element with singular edge and singular vertex}\label{caso4}
Let $T$ be a tetrahedral macro--element with vertices $P_0, P_1, P_2$ and $P_3$.
