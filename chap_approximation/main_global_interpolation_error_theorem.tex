...
tricks.
\noindent{\color{Orange}\#\#\#\#\#\#\# continue here3}  
\begin{IEEEeqnarray*}{rCl}
  h_1\|\gancho_{\eta_1}\bu_s\|&=&
  h_1\sum_{i=1}^3 \|\gancho_{\eta_1}\bu_{s,i}\|\\
  &\leqslant&
    \textit{h}\sum_{i=1}^3 \|r^{1-\mu}\gancho_{\eta_1}\bu_{s,i}\|\\
  &\leqslant&
    \textit{h}\left(
     \sum_{i=1}^2 \|R^{1-\mu}\theta^{1-\mu}\gancho_{\eta_1}\bu_{s,i}\|+
     \|R^{1-\mu}\gancho_{\eta_1}\bu_{s,3}\|\right)\\[7pt]
  &\leqslant&
    \textit{h}\left(
     \sum_{i=1}^2 \|R^{1-\nu}\theta^{1-\mu}\gancho_{\eta_1}\bu_{s,i}\|+
     \|R^{1-\nu}\gancho_{\eta_1}\bu_{s,3}\|\right)\\[7pt]
  &\leqslant&
    \textit{h}\left(
    \sum_{i=1}^2 \|R^{\beta}\theta^{\delta}\gancho_{\eta_1}\bu_{s,i}\|+
     \|R^{\beta}\gancho_{\eta_1}\bu_{s,3}\|\right)\\[7pt]
  &\leqslant&
    \textit{h}
    \left(\sum_{i=1}^2 \|\bu_{s,i}\|_{\scriptscriptstyle \beta,\delta}+
         \|\bu_{s,3}\|_{\scriptscriptstyle \beta,0}\right).
\end{IEEEeqnarray*}
Now, since $h_2\sim h_1$:
\begin{IEEEeqnarray*}{rCl}
  h_2\|\gancho_{\eta_2}\bu_s\|&=&
  h_2\sum_{i=1}^3 \|\gancho_{\eta_2}\bu_{s,i}\|\\
  &\leqslant&
    \textit{h}
    \left(\sum_{i=1}^2 \|\bu_{s,i}\|_{\scriptscriptstyle \beta,\delta}+
         \|\bu_{s,3}\|_{\scriptscriptstyle \beta,0}\right).
\end{IEEEeqnarray*}
\begin{IEEEeqnarray*}{rCl}
  h_3\|\gancho_{\eta_3}\bu_s\|&=&
  h_3\sum_{i=1}^3 \|\gancho_{\eta_3}\bu_{s,i}\|\\[7pt]
  &=&h_3\left(\sum_{i=1}^2\|\gancho_{\eta_i}\bu_{s,3}\|+
    \|\gancho_{\eta_3}\bu_{s,3}\|\right)\\[7pt]
  &\leqslant&\textit{h}\left(\sum_{i=1}^2\|d(K,v)^{1-\nu}\gancho_{\eta_i}\bu_{s,3}\|+
    \|d(K,v)^{1-\nu}\gancho_{\eta_3}\bu_{s,3}\|\right)\\[7pt]
  &\leqslant&
  \textit{h}\left(\sum_{i=1}^2\|R^{\beta}\gancho_{\eta_i}\bu_{s,3}\|+
    \|R^{\beta}\gancho_{\eta_3}\bu_{s,3}\|\right)\\[7pt]
  &=&
  \textit{h}\sum_{i=1}^3\|R^{\beta}\gancho_{\eta_i}\bu_{s,3}\|\\[7pt]
  &\lesssim&
  \textit{h}\|\bu_{s,3}\|_{\scriptscriptstyle \beta,0}
\end{IEEEeqnarray*}
\begin{IEEEeqnarray*}{rCl}
  h_K\|\dvg\bu_s\|&\leqslant&
  h_K\|\dvg\bu_s+\dvg\bu_r\|+h_K\|\dvg\bu_r\|\\[7pt]
...
\begin{IEEEeqnarray}{rCl}
  ...
  &\lesssim&
  {\color{green} \|\bu_s\|^2} + 
    {\color{blue}\|\pi\bu_s\|^2_{\scriptscriptstyle L^2(Tetra)^3}}\\[5pt]
  &&\,+\sum_{
  \substack{\text{ prisms }K\\
        d(E,\be) = 0}
    }
  {\color{green} \|\bu_s\|^2} + {\color{olive} \|\pi\bu_s\|^2_{\scriptscriptstyle L^2(E)^3}}.
\end{IEEEeqnarray}
\\[10pt]
...
${\color{blue}\|\pi\bu_s\|^2_{\scriptscriptstyle L^2(Tetra)^3}}$: First
\begin{IEEEeqnarray*}{rCl}
...
%  h_1^2\|\gancho_{\eta_1}\bu_s\|^2+
%  h_2^2\|\gancho_{\eta_2}\bu_s\|^2+
%  h_3^2\|\gancho_{\eta_3}\bu_s\|^2+
