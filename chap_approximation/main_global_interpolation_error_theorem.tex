...
\begin{IEEEeqnarray*}{rClCr}
  (h_1+h_2+h_3) \|\dvg \bu_s\|_{L^1(T_\ell)} & \leqslant &
    ...
    & \leqslant & 3 \textit{h}\,\sqrt{|T_\ell|}\,\left(\|f\|_{L^2(\Lambda_\ell)} + \|\dvg \bu_r\|_{L^2(T_\ell)}\right) \\[7pt]
    & \lesssim  & \textit{h}\,\sqrt{|T_\ell|}\,\|f\|_{L^2(\Lambda_\ell)}. \\[7pt]
\end{IEEEeqnarray*}
\end{enumerate}
\item
...
\begin{IEEEeqnarray*}{rCl}
  h_P\|\dv(u_{s,1},u_{s,1},0)\|_{L1}&\leqslant&h_P\|\dv\bu_s\|_{L1}
    ...
    &\lesssim&h_P\|\dv\bu_s\|_{L1} + h_3\|\partial_{\xi_3}u_{s,3}\|_{L1},
\end{IEEEeqnarray*}
and, as was done for these two terms before, we have
\begin{IEEEeqnarray*}{rCl}
  h_P\|\dv(u_{s,1},u_{s,1},0)\|_{L1}&\lesssim&\textit{h} |P|^{\nicefrac12}\|f\|_{L2(\Lambda_\ell)} +
...
\noindent{\color{Orange}\#\#\#\#\#\#\# en los lugarcitos en donde
llegu\'e hasta $\|f\|_{\Lambda_\ell}$ mejor para antes con la norma local de la
div, as\'i puedo sumar sobre elementos en macroel.}
...
*****************************************************
\subsection{main interpolation error theorem.}
