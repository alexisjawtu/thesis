...
$W^{1,1}(\Lambda_\ell)$.
We 
start pulling back to $\tilde{T}$ and then use Proposition 3.4 of~\cite{aadl}.
{\color{Orange}\#\#\#\#\#\#\#\# continue here3.}
\begin{IEEEeqnarray*}{rCl}
  \|(\br_0\bu_s)_1\|_{L^1(E)} &=& \int\limits_{\tilde{E}}|(A\tilde{\br}_0\tilde{\textbf{u}}_s)_1|\,d\tilde{x}\\[7pt]
...
%  h_1\sum_{i=1}^3 \|\gancho_{\xi_1}\textbf{u}_{s,i}\|\\
%  &\leqslant&
%    \textit{h}\sum_{i=1}^3 \|r^{1-\mu}\gancho_{\xi_1}\textbf{u}_{s,i}\|\\
%  &\leqslant&
%    \textit{h}\left(
%     \sum_{i=1}^2 \|R^{1-\mu}\theta^{1-\mu}\gancho_{\xi_1}\textbf{u}_{s,i}\|+
%     \|R^{1-\mu}\gancho_{\xi_1}\textbf{u}_{s,3}\|\right)\\[7pt]
%  &\leqslant&
%    \textit{h}\left(
