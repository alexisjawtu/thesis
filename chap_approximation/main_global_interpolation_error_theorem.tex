...
\begin{IEEEeqnarray*}{rCl}
  ...
  %& \leqslant & \|M_E^{-1}_{\text{row}_k}\|_\infty\|A_{\text{col}_l}\|_\infty\sum_{i,j = 1,2} \|\partial_{\xi_j}u_{s,i}\|_{L^{1}(K)}\\
...
\end{IEEEeqnarray*}
\noindent{\color{BrickRed}\#\#\#\#\#\#\# continue here y anotar para seguir 
...
\begin{enumerate}
  ...
  \end{IEEEeqnarray*}
    \item
  With respect to the derivatives orthogonal to the singular edge, take $i,j = 1,2$ and, by H\"older's inequality,
  \begin{IEEEeqnarray*}{rCl}
  ...
  \begin{IEEEeqnarray*}{rCl}
    ...
    \yesnumber\label{alongSingular}&\leqslant& C\,|K|^{1/2}\,\textit{h}\,\| u_{s,3} \|_{V_0^{1,2}(E)}.
  \end{IEEEeqnarray*}
    \item
  For the divergence we can do... recalling again the grading condition $h_1\sim h_2$,
  \begin{IEEEeqnarray*}{rCl}
