...
To estimate the approximation error of Section~\ref{auxlabel11}, 
we take the inequalities of
Theorem~\ref{aux_label47} and work with each term in the right--hand sides
...
{\color{red}CORREGIR: ahora ya puse las local interp estimates,
hay que cambiar esta frase, ya no va el \emph{we could} en condicional}
