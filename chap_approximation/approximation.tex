...
mesh, so that we get
\begin{IEEEeqnarray*}{rCl}
  &\leqslant&\sum_{K\in\mathcal{T}_{\textit{h}}}4\,\textit{h}^{2}
  \left[\sum_{|\alpha| = 1}\|D^\alpha\bu_r\|_{L^2(E)}^2 + 
...
\begin{IEEEeqnarray*}{rCl}
  ...
  \|\text{div}\bu_r\|_{L^2(\Omega)}\right).
\end{IEEEeqnarray*}
...
\noindent{\color{blue}\#\#\#\#\#\#\# continue here: ojo, hacer que quede
el cardinal de la malla $\mathcal{T}_{h_0}$ y no el N = nro. elem de malla. Ojo que N está 
