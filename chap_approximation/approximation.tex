...
y escribimos y demostramos nuestro teorema de global
interpolaci\'on, el cual el probado usando los espacios
...
and the we state the approximation errors.
...
global interpolation result which is proved using the 
